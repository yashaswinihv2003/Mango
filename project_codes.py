...
Original file is located at
    https://colab.research.google.com/drive/1ZVBHeeGwW34jfG566Di5kiYqnE4pjR3X
"""
...
st.write(f"Market: {market_type}")
st.write(f"Base Price (₹/kg): {base_price}")

# Paste new revenue code here
